...
export const siteData = {
  ...
  testimonials: [
    {
      ...
      image: 'https://images.unsplash.com/photo-1517840901100-8179e982acb7?q=80&w=600&auto=format&fit=crop'
    },
    {
      name: 'Michael Chen',
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1556912173-3bb406ef7e77?q=80&w=600&auto=format&fit=crop'
    }
  ],
  stats: [
  ...
  aboutImage: 'https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?q=80&w=2000&auto=format&fit=crop',
  experienceCenter: {
  ...
  solutions: [
    { icon: Sofa, label: 'Living Room', image: 'https://images.unsplash.com/photo-1583847268964-b28dc8f51f92?q=80&w=400&auto=format&fit=crop' },
    { icon: BedDouble, label: 'Bedroom', image: 'https://images.unsplash.com/photo-1616594039964-ae9021a400a0?q=80&w=400&auto=format&fit=crop' },
    { icon: ChefHat, label: 'Kitchen', image: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?q=80&w=400&auto=format&fit=crop' },
    { icon: Coffee, label: 'Dining Room', image: 'https://images.unsplash.com/photo-1497366216548-37526070297c?q=80&w=400&auto=format&fit=crop' },
    { icon: Lightbulb, label: 'Lighting', image: 'https://images.unsplash.com/photo-1503387762-592deb58ef4e?q=80&w=400&auto=format&fit=crop' },
    { icon: MonitorPlay, label: 'TV Unit', image: 'https://images.unsplash.com/photo-1593696954577-ab3d39317b97?q=80&w=400&auto=format&fit=crop' },
    { icon: Library, label: 'Study Room', image: 'https://images.unsplash.com/photo-1505693314120-0d443867891c?q=80&w=400&auto=format&fit=crop' },
    { icon: Bath, label: 'Bathroom', image: 'https://images.unsplash.com/photo-1620626011761-996317b8d101?q=80&w=400&auto=format&fit=crop' },
    { icon: TreePine, label: 'Balcony', image: 'https://images.unsplash.com/photo-1585128792020-803d29415281?q=80&w=400&auto=format&fit=crop' },
    { icon: Wind, label: 'False Ceiling', image: 'https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?q=80&w=400&auto=format&fit=crop' }
  ]
};
